...
class EmployeeManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('employees.*', 'division.name as division_name', 'division.id as division_id')
        ->paginate(5);
    ...
    public function edit($id)
    {
        ...
        'states' => $states, 'countries' => $countries, 'divisions' => $divisions]);
    }
    ...
    private function doSearchingQuery($constraints)
    {
        ...
        ->leftJoin('country', 'employees.country_id', '=', 'country.id')
        ->leftJoin('division', 'employees.division_id', '=', 'division.id')
        ->select('employees.nama_lengkap as nama_lengkap', 'employees.*', 'division.name as division_name', 'division.id as division_id');
    ...
    private function validateInput($request)
    {
        $this->validate($request, [
            ...
            'city_id' => 'required',
            'state_id' => 'required',
            'pendidikan' => 'required|max:60',
            'agama' => 'required|max:10',
            'status' => 'required|max:20',
            'alamat_domisili' => 'required|max:60',
            'alamat_ktp' => 'required|max:60',
            'nohp_pribadi' => 'required|max:15',
            'nohp_keluarga' => 'required|max:15',
            'no_kk' => 'required|max:25',
            'no_ktp' => 'required|max:25',
            'umur' => 'required',
            'birthdate' => 'required',
            'date_hired' => 'required',
